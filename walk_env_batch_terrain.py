...
class WalkENV(gym.Env):
    ...
    def __init__(self, render = True, backend = gs.gpu, num_envs = 100, device="cuda"):
        ...
        curriculum_terrains = [
            ["flat_terrain"] * a,
            ["wave_terrain"] * a,
            ["pyramid_sloped_terrain"] * a,
            ["fractal_terrain"] * a,
            ["pyramid_stairs_terrain"] * a,
            ["discrete_obstacles_terrain"] * a,
            ["random_uniform_terrain"] * a,
            ["stepping_stones_terrain"] * a,
            ["stairs_terrain"] * a,
            ["stairs_terrain"] * a
        ]
        ...
        self.scene.build(n_envs = self.num_envs, env_spacing = (8.0, 8.0))
    ...
    def _calculate_reward(self):
        ...
        trajectory_completed = self.terrain_lenght >= 68
    ...
    def _reset_idx(self, envs_idx):
        ...
        base_pos = torch.tensor([4, 2, 0.42], device=self.device).repeat(len(envs_idx), 1)
